    ...
    <section className="Advertising-containner">
      ...
      <div className="Advertising-containner-text">
        <div className="Advertising-preface-text-subtitle">
          ...
          <p>
            2. วิเคราะห์ข้อมูลและโอกาสทางการตลาด (Market Analysis)
            สำรวจพฤติกรรมผู้บริโภค คู่แข่ง และแนวโน้มตลาด
          </p>

          <p>
            3. วางแผนแคมเปญ (Campaign Planning) กำหนดช่องทาง กลยุทธ์ Creative
            และงบประมาณ
          </p>

          <p>
            4. ดำเนินการโฆษณา (Campaign Execution)
            ดูแลและติดตามประสิทธิภาพแบบรายวัน
          </p>

          <p>
            5. วัดผลและรายงานผลลัพธ์ (Optimization & Reporting)
            สรุปผลพร้อมคำแนะนำสำหรับรอบถัดไป
          </p>
        </div>
      </div>
        ...
        <div className="Advertising-preface-text-subtitle">
          <div className="Advertising-question-containner">
            ...
            <p>
              ...
              / TikTok ส่วนบริการเฉพาะทางเหมาะกับ Google Search
            </p>
          </div>
          ...
          <div className="Advertising-question-containner">
            ...
            <p>
              ...
              เราจะช่วยจัดสรรงบให้เหมาะสมกับเป้าหมายธุรกิจ.
            </p>
          </div>
          ...
          <div className="Advertising-question-containner">
            ...
            <p>
              ...
              หลักและคำแนะนำปรับปรุงอย่างเป็นระบบ. ให้ทีม PD Marketing
              ช่วยบริหารงบของคุณให้เกิดผลลัพธ์สูงสุด ด้วยกลยุทธ์ที่โปร่งใส
              ตรวจสอบได้ และมุ่งเน้นผลลัพธ์ทางธุรกิจจริง.
            </p>
          </div>
        </div>
      </div>
